 ...
 */
class Fraisforfait extends \FraisBundle\Entity\Fraisforfait implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'FraisBundle\\Entity\\Fraisforfait' . "\0" . 'id', '' . "\0" . 'FraisBundle\\Entity\\Fraisforfait' . "\0" . 'libelle', '' . "\0" . 'FraisBundle\\Entity\\Fraisforfait' . "\0" . 'montant');
        }
