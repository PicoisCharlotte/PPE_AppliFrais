 ...
 */
class Visiteur extends \FraisBundle\Entity\Visiteur implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'FraisBundle\\Entity\\Visiteur' . "\0" . 'id', '' . "\0" . 'FraisBundle\\Entity\\Visiteur' . "\0" . 'nom', '' . "\0" . 'FraisBundle\\Entity\\Visiteur' . "\0" . 'prenom', '' . "\0" . 'FraisBundle\\Entity\\Visiteur' . "\0" . 'login', '' . "\0" . 'FraisBundle\\Entity\\Visiteur' . "\0" . 'mdp', '' . "\0" . 'FraisBundle\\Entity\\Visiteur' . "\0" . 'adresse', '' . "\0" . 'FraisBundle\\Entity\\Visiteur' . "\0" . 'cp', '' . "\0" . 'FraisBundle\\Entity\\Visiteur' . "\0" . 'ville', '' . "\0" . 'FraisBundle\\Entity\\Visiteur' . "\0" . 'dateembauche');
        }
